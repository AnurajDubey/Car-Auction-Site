...
<body>
	...
	try{
		...
		String string_wingspan = request.getParameter("wingspan");
		String string_capacity = request.getParameter("capacity");
		String string_planetype = request.getParameter("plane_type"); 
		...
		//insert into car
		String insert_in_plane = "INSERT INTO plane(name, wingspan, capacity, plane_type, itemID) VALUES(?,?,?,?,?)" ; 
