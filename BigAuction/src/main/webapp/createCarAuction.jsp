...
<body>
	...
	try{
		...
		String string_mileage = request.getParameter("mileage");
		String string_drivetrain = request.getParameter("drivetrain");
		String string_cartype = request.getParameter("car_type"); 
		...
		//insert into car
		String insert_in_car1 = "INSERT INTO car(name, mileage, drivetrain, car_type, itemID) VALUES(?,?,?,?,?)" ; 
